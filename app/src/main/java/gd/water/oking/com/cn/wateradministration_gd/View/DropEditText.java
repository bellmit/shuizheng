...
public class DropEditText extends FrameLayout implements View.OnClickListener, OnItemClickListener {
    ...
    private OnDropEditTextItemClickListener onDropEditTextItemClickListener;
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
                            long id) {
        //mEditText.setText(((Litigant) mPopView.getAdapter().getItem(position)).getName());
        if (onDropEditTextItemClickListener != null) {
            onDropEditTextItemClickListener.onItemClick(position);
        }
    ...
    public void setOnDropEditTextItemClickListener(OnDropEditTextItemClickListener onDropEditTextItemClickListener) {
        this.onDropEditTextItemClickListener = onDropEditTextItemClickListener;
    }

    public interface OnDropEditTextItemClickListener {
